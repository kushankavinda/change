            ...
            <div id="main_content">
                ...
                <div class="left_content">
                    ...
                    <ul class="left_menu">
                        ...
                        <li class="odd"><a href="#">Vehicals</a></li>
                        ...
                        <li class="odd"><a href="#">Pillows</a></li>
                ...
                <div class="center_content">
                    <div class="oferta">
                        <%for (int i = 8; i < 12; i++) {%>            
                        <a href="viewDetails.jsp?value=<%=i%>"><img src="getImage.jsp?id=<%=i%>" width="165" height="113" border="0" class="oferta_img" alt="" /></a>

                        <%}%>
                        <div class="oferta_details">
                            <div class="oferta_title">Special Products Offers</div>
                ...
                <div class="right_content">
                    ...
                    <ul class="left_menu">
                        ...
                        <li class="even"><a href="#">Western Province</a></li>
                        <li class="odd"><a href="#">Southren Province</a></li>
