                ...
                <div class="center_content">
                    ...
                    <div class="prod_box_big">
                        <div class="center_prod_box_big">
                            <div class="product_img_big"> <a href="javascript:popImage('getImage2.jsp?id=<%=imageId%>','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="getImage2.jsp?id=<%=imageId%>" alt="" border="0" width="165" height="113"/></a>
                            ...
                            <div class="details_big_box">
                                ...
                                <%  String p;
                                    String sql = "SELECT * FROM admimnaddtable where post_id="+imageId;
