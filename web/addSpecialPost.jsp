        ...
        <div id="main_container">
            ...
            <div id="main_content">
                ...
                <div class="center_content">
                    ...
                    <div class="center_title_bar">Add Special Post</div>
                        ...
                        <div class="center_prod_box_big">
                            <div class="contact_form">
                                ...
                                <form action="uploadImage" method="post" enctype="multipart/form-data">
                                    <div class="form_row">
                                        <label class="contact"><strong>Add Type:</strong></label>
                                        <select name="addtype" class="contact_input" style="float : left">
                                            <option value="special">Special Add</option>
                                            <option value="normal">Normal Add</option>

                                        </select>
                                    </div>

                                    <div class="form_row">
                                        <label class="contact"><strong>Heading :</strong></label>
                                        <input type="text" name="name"  class="contact_input" placeholder="heading" required/>
                                    </div>

                                    <div class="form_row">
                                        <label class="contact"><strong>category:</strong></label>
                                        <select name="category" class="contact_input" style="float : left">
                                            <option value="clothes">clothes</option>
                                            <option value="pillows">pillows</option>
                                            <option value="Moblie Phones">Moblie Phones</option>
                                            <option value="laptops">laptops</option>
                                        </select>
                                    </div>
                                    <div class="form_row">
                                        <label class="contact"><strong>Type:</strong></label>
                                        <select name="type" class="contact_input" style="float : left">
                                    ...
                                    <div class="form_row">
                                        ...
                                        <select name="area" class="contact_input" style="float : left">
                                    ...
                                    <div class="form_row">
                                        ...
                                        <input type="text" name="address" class="contact_input" placeholder="address" required/>
                                    </div>
                                    <div class="form_row">
                                    ...
                                    <div class="form_row">
                                        ...
                                        <textarea name="desc" class="contact_textarea" ></textarea>
                                    </div>
                                    <div class="form_row">
                                    ...
                                    <div class="form_row">   <input type="submit" style=" color:red"/> </div>
