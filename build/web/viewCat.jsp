                                                    ...
                                                    <input type="checkbox" checked="checked"> Remember me
                                                        ...
                                                        <div id="main_content">
                                                            ...
                                                            <div class="left_content">
                                                                ...
                                                                <%try {
                                                                        String s = "SELECT * FROM admimnaddtable";
                                                                %> <%@include file="viewMoreDetails.jsp"%> <%                        resultSet = statement.executeQuery(s);
                                                               String a1 = null;
                                                               while (resultSet.next()) {
                                                                        a1 = resultSet.getString("post_id");%>

                                                                <div class="border_box">
                                                                    <div class="product_title"><a href="viewDetails2.jsp?value=<%=a1%>"><%=resultSet.getString("name")%></a></div>
                                                                    <div class="product_img"><a href="viewDetails2.jsp?value=<%=a1%>"><img src="getImage2.jsp?id=<%=a1%>" alt="" border="0" width="150" height="150" /></a></div>
