            ...
            <div id="main_content">
                ...
                <div class="center_content">
                 ...
                 <!--   <div class="prod_box_big">
                     ...
                     String heading,id,price;
                      %>
                            
                          <%  
                                    String sql = "SELECT name,price,post_id FROM post where email=" +"'"+ user_email+"'";
                    ...
                    <div class="prod_box">
                        <div class="center_prod_box">
                             ...
                             <div class="product_title"><a href="viewMyPostDetails.jsp?value=<%=id%>"><%=heading%></a></div>
                            <div class="product_img"><a href="viewMyPostDetails.jsp?value=<%=id%>"> <img src="getImage.jsp?id=<%=id%>"  width="80px" height="70px" alt="" border="0" class="oferta_img1" /> </a>  </div>
                        ...
                        <%}
                            ...
                            out.println("no posts from you,sorry !!!");
                        } 
