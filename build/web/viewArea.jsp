        ...
        <div id="main_container">
            ...
            <div id="main_content">
                ...
                <div class="left_content">
                    ...
                    <ul class="left_menu">
                        <li class="even"><a href="viewCat.jsp?cat=all&area=<%=area%>">All Products</a></li>
                        <li class="odd"><a href="viewCat.jsp?cat=pillows&area=<%=area%>">Pillows</a></li>
                        <li class="even"><a href="viewCat.jsp?cat=Moblie Phones&area=<%=area%>">Moblie Phones</a></li>
                ...
                <div class="center_content">
                    ...
                    <div class="center_title_bar">Search Results > <%=area%> > <%=cat%> </div>
                    ...
                    <%  String sql;
                        if (area.equals("all")){
                            if(cat.equals("all")){
                                 ...
                                 sql = "SELECT * FROM post where category=" + "'" + cat + "'";
                            }
                        }else {
                            if (cat.equals("all")) {
                                sql = "SELECT * FROM post where area=" + "'" + area + "'";
                            }else {
                                sql = "SELECT * FROM post where area=" + "'" + area + "'" + "and category=" + "'" + cat + "'";
                            }
                        }
                ...
                <div class="right_content">
                    ...
                    <ul class="left_menu">
                        <li class="even"><a href="viewArea.jsp?area=all&cat=<%=cat%>">All Areas</a></li>
                        <li class="odd"><a href="#">Eastern Province</a></li>
                        <li class="even"><a href="viewArea.jsp?area=western&cat=<%=cat%>">Western Province</a></li>
                        <li class="odd"><a href="viewArea.jsp?area=southern&cat=<%=cat%>">Southren Province</a></li>
